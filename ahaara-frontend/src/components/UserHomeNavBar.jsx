...
//   const navItems = [
//     { text: "Provide Food", path: "/addFood", textOnly: true  },
//     { text: "Request Food", path: "/allFoods", textOnly: true },
//     { text: "Profile", path: "/myprofile", textOnly: true  },
//     { text: "Logout", path: "/", textOnly: true },
//   ];
...
//                   <Link to={item.path} style={{ textDecoration: "none", color: "" }}>
//                     {item.text}
//                   </Link>
//                 </Typography>
//               ) : (
...
const UserHomeNavBar = () => {
  ...
  const desktopNavItems = [
    { text: "Provide Food", path: "/addFood" },
