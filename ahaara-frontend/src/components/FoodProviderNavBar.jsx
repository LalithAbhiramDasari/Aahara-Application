...
const FoodProviderNavBar = () => {
  ...
  const desktopNavItems = [
    { text: "Add Food", path: "/addFood" },
    { text: "My Providings", path: "/myProvidings" },
    { text: "Food Requests", path: "/foodRequests" },
  ];
...
export default FoodProviderNavBar;
