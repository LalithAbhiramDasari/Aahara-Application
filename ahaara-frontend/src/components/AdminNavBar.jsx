...
const AdminNavBar = () => {
  ...
  const navItems = [
    { text: "View Users", path: "/viewAllUsers", textOnly: true },
    { text: "View Food", path: "/viewAllFood", textOnly: true } ,
    { text: "Food Requests", path: "/viewAllRequests", textOnly: true },
    { text: "Log out", path: "/", textOnly: true },
  ];
